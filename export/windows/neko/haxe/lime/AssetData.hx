...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/aa.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/map2.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/pusher.png", Reflect.field (AssetType, "image".toUpperCase ()));
